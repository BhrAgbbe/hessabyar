...
import { editTransaction, deleteTransaction, type Transaction } from '../../store/slices/transactionsSlice';
    ...
    return (
        <Box>
            ...
            <ConfirmationDialog
                ...
                message={`آیا از حذف ${toPersianDigits(deleteConfirm.ids.length)} تراکنش اطمینان دارید؟`}
            />
